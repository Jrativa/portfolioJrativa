...
export const Banner = () => {
    ...
    const scrollToSection = () => {
        // Encuentra el elemento con el id "connect"
        const section = document.getElementById('connect');
    
        // Verifica si se encontró el elemento antes de realizar el desplazamiento
        if (section) {
            ...
            <Container>
                <Row className="align-items-center">
                    <Col xs={12} md={6} className="banner-left">
                        ...
                        <button onClick={scrollToSection}>{`Let's make amazing things :)`}<ArrowRightCircle size={25} /></button>
                    </Col>
